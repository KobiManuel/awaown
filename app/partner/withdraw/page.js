...
import { Wallet, Banknote, ArrowUpRight, Clock, ShieldAlert, ShieldCheck } from "lucide-react";
...
export default function PartnerWithdrawPage() {
  ...
  const pendingInEscrow = earnings
    ...
    <div className="flex flex-col gap-5 pb-6 font-shop lg:mx-auto lg:w-full lg:max-w-[900px]">
      ...
      <div className="mx-4 lg:mx-8">
        ...
        >
          ...
          {verification.status === "verified" ? "Withdraw Funds" : "Verify to Withdraw"}
        </button>
      </div>
