    ...
    <div className="flex flex-col gap-4 pb-4 font-shop lg:mx-auto lg:w-full lg:max-w-[1100px]">
      ...
      <div className="mx-4 flex items-center gap-3 rounded-[14px] bg-shop-bg p-3.5 lg:mx-8">
        ...
        <p className="text-[12px] leading-[18px] text-shop-text">
          These are the products live in{" "}
          <span className="font-semibold text-shop-heading">{storeName}</span> right now.
          Each one has its own shareable link, and your full store link shares all of them
          at once.
        </p>
      </div>
            ...
            >
              <div className="flex gap-3">
                <Link
                  ...
                  className="relative flex h-16 w-16 shrink-0 items-center justify-center overflow-hidden rounded-[10px] bg-shop-bg"
                >
                  {product.images?.[0] ? (
                    <Image
                ...
                <div className="min-w-0 flex-1">
                  <Link
                    href={`/product/${product.id}`}
                    className="line-clamp-1 text-[13px] font-medium text-shop-heading hover:underline"
                  >
                    {product.title}
                  </Link>
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="flex flex-1 items-center justify-center gap-1.5 rounded-[10px] border border-shop-border py-2.5 text-[12.5px] font-semibold text-shop-heading transition-colors hover:bg-shop-bg"
                >
