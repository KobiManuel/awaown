...
const SECTIONS = [
  { key: "hero", label: "Hero banner (Desktop)", aspect: 16 / 7, className: "aspect-[16/7]" },
  { key: "heroMobile", label: "Hero banner (Mobile)", aspect: 4 / 5, className: "aspect-[4/5]" },
  { key: "merchants", label: "Merchants", aspect: 1, className: "aspect-square" },
  { key: "partners", label: "Partners", aspect: 1, className: "aspect-square" },
  { key: "investors", label: "Inventory Investors", aspect: 1, className: "aspect-square" },
  { key: "customers", label: "Customers", aspect: 1, className: "aspect-square" },
];
  ...
  return (
    <div className="flex flex-col gap-2.5 px-4 pb-4 lg:px-8">
      ...
      <p className="text-[11.5px] text-shop-text/60">
        ...
        The hero banner has a separate mobile crop - a wide desktop photo looks
        cramped on a phone, so upload a more upright version for it too. This
        feeds the public{" "}
            ...
            {SECTIONS.map((s) => (
              <div key={s.key} className="flex flex-col gap-1.5">
                <AboutImageSlot
                  ...
                  className={`w-full rounded-[16px] ${s.className}`}
                />
