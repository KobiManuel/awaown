...
export default function AdminAutomationsPage() {
  ...
  const { data, isLoading } = useGetAutomationsQuery();
  ...
  return (
    <div className="flex flex-col gap-4 pb-6 font-shop lg:mx-auto lg:w-full lg:max-w-[900px]">
      ...
      <p className="px-4 text-[11.5px] text-shop-text/60 lg:px-8">
        Create simple trigger → action automations instead of manual staff work. Enabled
        rules run automatically and send the matching notification as events happen.
      </p>
