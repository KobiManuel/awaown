...
export default function PartnerCartButton({ code }) {
  ...
  return (
    <Link
      ...
      className="fixed bottom-5 right-5 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-shop-accent-1 text-white shadow-lg transition-transform hover:scale-105"
    >
