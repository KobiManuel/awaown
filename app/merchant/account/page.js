    ...
    <div className="flex flex-col gap-5 pb-4 font-shop lg:mx-auto lg:w-full lg:max-w-[640px] lg:pb-10">
      ...
      <div className="mx-4 flex flex-col gap-3 rounded-[14px] border border-shop-border bg-white p-4 lg:mx-0">
        ...
        <button
          ...
          className="flex items-center gap-3 rounded-[10px] border border-dashed border-shop-border px-3 py-3 text-left"
        >
          <span className="flex h-9 w-9 items-center justify-center rounded-full bg-shop-bg">
            <ImagePlus className="h-4.5 w-4.5 text-shop-heading" strokeWidth={1.75} />
          </span>
          <span className="flex-1 text-[12.5px] font-medium text-shop-heading">
            {storeBanner ? "Change store banner" : "Upload store banner"}
          </span>
        </button>
