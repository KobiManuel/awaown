  ...
  const handleSubmit = (e) => {
    ...
    dispatch(
      addProduct({
        ...
        video,
        hasVariants,
        price: hasVariants ? (Number.isFinite(minPriceForPreview) ? minPriceForPreview : 0) : Number(price),
        ...
        status: "active",
        offerCommission,
        partnerProfitAmount: offerCommission ? Number(partnerProfitAmount) : null,
        hideStock,
      }),
    );
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-6 px-4 lg:px-0">
        ...
        <div className="flex flex-col gap-2.5">
          <p className="text-[13px] font-semibold text-shop-heading">
            Does this product come in different options?
          </p>
          <p className="text-[11.5px] text-shop-text">
            Like color or size — each option can have its own price and stock.
          </p>
          <div className="flex gap-3">
            <TypeCard
