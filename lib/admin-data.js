...
export const TEAM_ROLES = [
  { id: "super_admin", label: "Super Admin", description: "Owner tier. Full access, and the only role that can add, remove or re-role admin accounts." },
  { id: "administrator", label: "Administrator", description: "Full access to every module. Cannot delete admin accounts or grant/revoke the Super Admin role." },
...
export const merchantsDirectory = [
  { id: "m-1", storeName: "Fashion Vault", owner: "John Doe", status: "active", verification: "unverified", products: 6, rating: 4.8, joinedAt: "2025-11-02", revenue: 382000 },
  { id: "m-2", storeName: "Glow Beauty NG", owner: "Ifeoma Chukwu", status: "active", verification: "pending", products: 14, rating: 4.6, joinedAt: "2026-01-14", revenue: 614500 },
  { id: "m-3", storeName: "TechHub Lagos", owner: "Emeka Obi", status: "active", verification: "verified", products: 22, rating: 4.7, joinedAt: "2025-08-21", revenue: 891200 },
  { id: "m-4", storeName: "Urban Soles", owner: "Ngozi Adeyemi", status: "suspended", verification: "verified", products: 9, rating: 4.2, joinedAt: "2025-06-03", revenue: 148300 },
  { id: "m-5", storeName: "Kaba & Co", owner: "Bashir Musa", status: "active", verification: "unverified", products: 3, rating: 4.9, joinedAt: "2026-02-28", revenue: 96700 },
];
...
export const communitySectionDefaults = {
  ...
  webinar: {
    ...
    // Registration link (Zoom, Google Meet, a landing page, etc.). The "Save Your
    // Seat" button on the homepage opens this once content editing is wired live.
    url: "",
  },
  tip: {
...
export const homepageContentDefaults = {
  ...
  reviews: {
    ...
    testimonials: [
      { name: "Chiamaka Nwosu", role: "Verified Buyer, Lagos", quote: "I was skeptical about shopping online in Nigeria until I found AwaOwn. Escrow means my money is only released after I confirm delivery, and that alone won me over." },
      { name: "Ifeoma Chukwu", role: "Merchant, Glow Beauty NG", quote: "Since listing on AwaOwn, my orders have grown month over month. Onboarding was simple and payouts land on time, every time. I'd recommend it to any Nigerian vendor." },
      { name: "Tunde Bakare", role: "Verified Buyer, Ibadan", quote: "Fast delivery, real reviews, and a support team that actually responds. AwaOwn feels built for how Nigerians actually shop." },
      { name: "Emeka Obi", role: "Verified Buyer, Abuja", quote: "I've bought electronics and fashion items here without a single hitch. The tracking updates keep me informed the whole way." },
    ],
  },
  // Extra, opt-in content block, off by default. Demonstrates how a new homepage
  // feature (e.g. a recurring "Merchant of the Week/Month" spot) slots into this same
  // section-editor pattern, with its own visibility toggle in sectionVisibility below.
  merchantOfWeek: {
    merchantId: "",
    note: "",
  },
  freeShipping: {
    message: "Free delivery now on your first order and over ₦200 - Only ₦200*",
    bgColor: "#6D28D9",
  },
};

// Per-section on/off switches for the homepage editor, so an admin can hide a section
// rather than delete its content, e.g. keep Deal of the Week's copy saved but switch
// it off during a week with no active deal, or turn Merchant of the Week on only when
// there's one to feature, so the page doesn't get crowded with every possible block at
// once.
export const sectionVisibilityDefaults = {
  hero: true,
  threeBannerRow: true,
  dealOfWeek: true,
...
// Multiple can be active at once, e.g. Paystack as primary with Flutterwave as a
// fallback for cards Paystack declines, or so checkout can offer a customer's
// preferred provider. Each provider handles its own transactions independently.
