// Shared demo content for the Optimall-inspired homepage clone.
// Images are pooled from the extracted Shopify assets + the existing
// AwaOwn/Awashop product photography, reused across cards like the
// source demo store does.
...
export const fashionTabs = {
  Fashion: [
    ...
    { title: "Women Solid Round Neck Cotton T-Shirt", vendor: "Optimall", price: 24.5, compareAt: null, image: productImages.dress, hoverImage: productImages.cosmetics, swatches: swatchSets[1] },
  ...
  Furniture: [
    ...
    { title: "Bottle Grinder Set Ceramic Spice Mill", vendor: "Optimall", price: 18.5, compareAt: 24, image: productImages.cosmetics, hoverImage: productImages.dress, badge: "Sale", swatches: swatchSets[1] },
...
export const purchaseNotifications = [
  { title: "Apple iPad Pro (12.9-inch, Wi-Fi + Cellular, 64GB)", image: productImages.trackIphone, location: "Japan" },
  { title: "Google Pixel Buds, Pixelbook Go, Nest Wifi", image: productImages.earbuds, location: "Germany" },
  { title: "Nike Air Gold Pink V Series Cast Shoes", image: productImages.sneakerWhite, location: "Canada" },
  { title: "Women's Solid Formal Pink Blazer", image: productImages.dress, location: "United Kingdom" },
  { title: "MVMT Chrono Analog Black Dial Watch", image: productImages.real21, location: "Australia" },
  { title: "iPhone 13, 128GB, Pink - Unlocked Premium", image: productImages.iphone, location: "United States" },
];

export const categoryMenu = [
  { title: "Our Store", href: "#" },
  {
    title: "Furniture",
    href: "#",
    children: ["Bottle Grinder", "Pillow", "Sofas", "Poufs", "Cabinet Table"],
  },
  {
    title: "Fashion",
    href: "#",
    children: ["Purse", "Shoes", "T-Shirt", "Tote Bag"],
  },
  { title: "Men's Clothes", href: "#" },
  {
    title: "Electronics",
    href: "#",
    children: ["Laptop", "Mobile", "Tablet", "Watch", "Headphones"],
  },
  { title: "Women's Bag", href: "#" },
  { title: "Diamond Cluster", href: "#" },
  {
    title: "Jewellery",
    href: "#",
    children: ["Necklace", "Earrings", "Drop Earrings", "Silver Earrings"],
  },
  { title: "Headphones", href: "#" },
  { title: "Bottle Grinder", href: "#" },
  {
    title: "Retro Fashion",
    href: "#",
    children: ["Bucket Hat", "Denim Skirt", "Shimmer Tie-Dye"],
  },
  { title: "Sneakers Shoes", href: "#" },
  { title: "Sunglasses", href: "#" },
  { title: "Leather Watch", href: "#" },
];
