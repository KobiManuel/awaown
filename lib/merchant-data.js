...
// Matches the live site's Categories mega-menu (awaown.com) so merchants pick from
// the same taxonomy shoppers browse by. Grouped for the UI (optgroups); PRODUCT_CATEGORIES
// stays a flat list of {slug, label} for every existing lookup (categoryLabel(), filter
// chips, etc.) that expects one.
export const PRODUCT_CATEGORY_GROUPS = [
  {
    ...
    items: [
      ...
      { slug: "traditional-attire", label: "Traditional Attire" },
    ],
  },
  {
    ...
    items: [
      ...
      { slug: "electronics-accessories", label: "Accessories" },
    ],
  },
  {
    group: "Beauty & Health",
  ...
  },
  {
    ...
    items: [
      { slug: "dry-foods", label: "Dry Foods" },
  ...
  },
  {
    ...
    items: [
      ...
      { slug: "bedding-bath", label: "Bedding & Bath" },
  ...
  },
  {
    ...
    items: [
      { slug: "gym-equipment", label: "Gym Equipment" },
      { slug: "sportswear", label: "Sportswear" },
      { slug: "outdoor-sports", label: "Outdoor Sports" },
  ...
  },
  {
    ...
    items: [
      ...
      { slug: "tyres-wheels", label: "Tyres & Wheels" },
      { slug: "car-care", label: "Car Care" },
    ],
  },
  {
    group: "Books & Education",
    items: [
      { slug: "textbooks", label: "Textbooks" },
      { slug: "fiction", label: "Fiction" },
      { slug: "business-books", label: "Business" },
      { slug: "childrens-books", label: "Children's Books" },
    ],
  },
];

export const PRODUCT_CATEGORIES = PRODUCT_CATEGORY_GROUPS.flatMap((g) => g.items);
