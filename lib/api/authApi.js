...
export const authApi = baseApi.injectEndpoints({
  endpoints: (build) => ({
    ...
    verifyRegistration: build.mutation({
      query: ({ role, email, code, rememberMe }) => ({
    ...
    loginPassword: build.mutation({
      query: ({ role, email, password, rememberMe }) => ({
    ...
    checkResetCode: build.mutation({
      query: ({ role, email, code }) => ({
        url: `/auth/${role}/reset-password/check`,
        method: "POST",
        body: { email, code },
      }),
    }),
    ...
    closeAccount: build.mutation({
      query: ({ role }) => ({
        url: `/auth/${role}/close-account`,
        method: "POST",
      }),
      invalidatesTags: ["Me"],
    }),
...
export const adminAuthApi = baseApi.injectEndpoints({
  endpoints: (build) => ({
    ...
    adminCheckResetCode: build.mutation({
      query: ({ email, code }) => ({
        url: `/admin/auth/reset-password/check`,
        method: "POST",
        body: { email, code },
      }),
    }),
