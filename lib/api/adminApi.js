...
export const adminApi = baseApi.injectEndpoints({
  endpoints: (build) => ({
    ...
    deleteAdminCoupon: build.mutation({
    ...
    resendTeamInvite: build.mutation({
      query: (id) => ({
        url: `/admin/team/${id}/resend-invite`,
        method: "POST",
      }),
    ...
    resetPageViews: build.mutation({
      query: () => ({ url: "/admin/analytics/page-views", method: "DELETE" }),
    ...
    saveAboutImage: build.mutation({
      query: ({ key, url }) => ({
        url: `/admin/content/about/${key}`,
        method: "PATCH",
        body: { url },
      }),
      invalidatesTags: ["Settings", "AuditLog"],
...
export const {
  ...
  useResetPageViewsMutation,
  useGetHomepageCmsQuery,
  useSaveHomepageCmsMutation,
  useSaveAboutImageMutation,
