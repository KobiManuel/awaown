...
// Terminology per the project spec: no "affiliate"/"commission"/"resell" — partners
// promote products and earn a profit share the merchant sets. AwaOwn keeps 20% of a
// partner's profit share as a platform fee (see lib/payout-banks.js). This fee is
// confidential — never surface it in merchant-facing UI (only in partner-facing UI,
// where it explains their own net payout).
...
export const partnerProfile = {
  ...
  referralLink: `${SITE_URL}/store/JOHNDOE15`,
  totalReferrals: 34,
};
